...
%citeste o imagine
 img = imread('../data/pisica.png');
% img = imread('footbal.jpg');

%reducem imaginea in latime cu 50 de pixeli
%seteaza parametri
parametri.optiuneRedimensionare = 'maresteInaltime'; %'micsoreazaLatime';'miscoreazaInaltime';'maresteLatime';'maresteInaltime';'amplificaContinut';'eliminaObiect'
...
imwrite(imgRedimensionata_proiect,'castelpd.png');
